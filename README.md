...
Uma aplicação web (desktop) de **agenda de contatos**, desenvolvida com **Node.js e Express**, com autenticação de usuários e um CRUD completo para gerenciamento de contatos.
